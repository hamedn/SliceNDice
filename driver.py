...
all_views = ['view1', 'view2', 'view3']  # specify relevant set of views to consider
...
example_job_params = SliceNDiceJobParams(
    ...
    view_limit=3,  # only look for groups across this many views
...
slicer.parallelize_block_discovery(n_blocks_per_thread=5, n_threads=1)
